...
set output 'images/histogramme_verticale.png'
...
convert -rotate 90 images/histogramme_verticale.png images/histogramme_inclinee.png

# Ouvrir l'image inclinée
xdg-open images/histogramme_inclinee.png
