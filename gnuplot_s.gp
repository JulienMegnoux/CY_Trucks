...
plot 'temp/vamos.txt' using ($0+increment_index):3:4 with filledcurve fc rgb Shadecolor title "Distance max/min", '' using ($0+increment_index):5:xticlabels(1) with boxes smooth mcspline lw 2 title "Distance average"
